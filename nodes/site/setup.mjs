...
import {routeSearchExternalAccount} from "./handlers/searchExternalAccount.mjs";
import {routeGetSiteTemplates} from "./handlers/getSiteTemplates.mjs";
...
export function setup(app, {setup, teardown}) {
    ...
    app.use("/v2", routerV2)
    setup(routerV2)
    routeSearchExternalAccount(routerV2)
    routeGetSiteTemplates(routerV2)
    teardown(routerV2)
}